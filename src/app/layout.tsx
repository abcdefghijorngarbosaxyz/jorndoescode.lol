...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang='en' className='scroll-pt-[calc(var(--header-height)_+_16px)] text-[16px]'>
      <body className='m-0 h-full overflow-x-hidden bg-white font-sans font-light antialiased selection:bg-[rgb(229,_229,_229)] dark:bg-neutral-950 dark:selection:bg-[rgb(64,_64,_64)]'>
